...
export const GUIDED_QUESTIONS: Record<Section, GuidedQuestion[]> = {
  family: [
    ...
    },
    {
      ...
      help: "List names and ages. If you do not have children, enter “None.”",
  ...
  assets: [
    ...
    },
    {
      section: "assets",
      key: "inheritance_age",
      prompt: "At what age should a child receive an inheritance outright?",
      help: "Enter an age or “Not applicable.”",
